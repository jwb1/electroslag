...
namespace detail
{
	...
	inline image::data_type* image::compute_data(size_type NewBaseLayer, size_type NewBaseFace, size_type NewBaseLevel)
	{
		size_type const BaseOffset = this->Storage->base_offset(NewBaseLayer, NewBaseFace, NewBaseLevel);
