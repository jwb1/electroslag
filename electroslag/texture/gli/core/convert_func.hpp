...
namespace detail
{
	...
	{
		static tvec4<retType, P> fetch(textureType const &, typename textureType::extent_type const &, typename textureType::size_type, typename textureType::size_type, typename textureType::size_type)
		{
			return tvec4<retType, P>(0, 0, 0, 1);
		}

		static void write(textureType &, typename textureType::extent_type const &, typename textureType::size_type, typename textureType::size_type, typename textureType::size_type, tvec4<retType, P> const &)
		{}
	};
